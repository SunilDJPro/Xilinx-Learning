...
HD_PWD='/home/sunil/Xilinx-Learning/BasicLE_PYNQZ2/BasicLE_PYNQZ2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_le_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basic_le_demo.tcl
