...
HD_PWD='/home/sunil/Xilinx-Learning/BasicLE_PYNQZ2/BasicLE_PYNQZ2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basic_le_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basic_le_demo.tcl -notrace
