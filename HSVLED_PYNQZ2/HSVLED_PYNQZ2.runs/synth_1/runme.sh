...
HD_PWD='/home/sunil/Xilinx-Learning/HSVLED_PYNQZ2/HSVLED_PYNQZ2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_z2_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pynq_z2_top.tcl
