...
HD_PWD='/home/sunil/Xilinx-Learning/HSVLED_PYNQZ2/HSVLED_PYNQZ2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_z2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pynq_z2_top.tcl -notrace
