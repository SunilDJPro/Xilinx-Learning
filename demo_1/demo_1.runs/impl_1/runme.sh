...
HD_PWD='C:/Users/DELL/Documents/Xilinx-Learning/demo_1/demo_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_data.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source half_adder_data.tcl -notrace
