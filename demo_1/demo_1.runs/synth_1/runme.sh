...
HD_PWD='C:/Users/DELL/demo_1/demo_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_adder_data.tcl
