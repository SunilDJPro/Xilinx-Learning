...
HD_PWD='/home/sunil/Xilinx-Learning/4bAdderRiple-PYNQZ2/4bAdderRiple-PYNQZ2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_adder_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ripple_adder_top.tcl -notrace
