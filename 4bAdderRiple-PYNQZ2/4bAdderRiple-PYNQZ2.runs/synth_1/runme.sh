...
HD_PWD='/home/sunil/Xilinx-Learning/4bAdderRiple-PYNQZ2/4bAdderRiple-PYNQZ2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_adder_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_adder_top.tcl
